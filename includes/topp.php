  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Topbar -->
        <nav class="navbar navbar-expand navbar-light bg-whit topbar mb-4 static-top shadow" style="background-color:#4E4D51;">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center"  style="text-decoration: none; font-size: 18px; font-weight: bold;" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">Point Of Sale System</div>
      </a>
      <?php $today = date("mdGis"); ?>
          <!-- Topbar Navbar -->
          <ul class="navbar-nav ml-auto">

            <!-- <li class="nav-item dropdown no-arrow">
              <a class="nav-link" href="pos.php?trans_d=<?php// echo $today ?>" role="button">
