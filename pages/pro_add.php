...
?>
          <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
           ...
           <div class="form-group">
             <input type="number"  min="1" max="9999999999" class="form-control" placeholder="Selling Price" name="price" required>
           </div>
          
           <div class="form-group">
             <input type="number"  min="1" max="9999999999" class="form-control" placeholder="Wholesale Price" name="wprice" required>
           </div>
                            <div class="form-group">
                              <?php
                                echo $opt;
