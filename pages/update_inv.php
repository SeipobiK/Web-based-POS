...
if ($Aa=='User'){
            ...
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">UPDATE INVENTORY</h4>
            </div>
            ...
            <div class="card-body">
                        ...
                        <form role="form" method="post" action="INV_transec.php?action=add">
                          <div class="form-group">
                              <input class="form-control" placeholder="product id" name="PRODUCT_ID" required>
                            <div class="form-group">
                              <input class="form-control" placeholder="stock quantity" name="QUANTITY" required>
                            </div>
                            <hr>
