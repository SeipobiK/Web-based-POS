...
<body class="bg-gradient-prima" style="background-color:white;">
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <img src="pos.png"   style="width:100%;max-width:400px" alt="Lights"></img>
              <!-- <div class="col-lg-6 d-none d-lg-block bg-login-image"></div> -->
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">T & T  POINT  OF  SALE    SYSTEM </h1>
                  </div>
